...
/*
  Note: this covert channel is finetuned for Intel Core i5-7500 (Kaby Lake, 12 way LLC).
  This setting is hardcoded in prime.h
*/
...
// Now include the cache info file
...
/*
  ...
  transmitter and receiver reside on different physical cores.
  In case of a hyperthreaded machine, logical siblings can be learned, e.g.: 
  cat /sys/devices/system/cpu/cpu0/topology/thread_siblings_list 
*/
#define TRANSMITTER_CORE    2
#define RECEIVER_CORE       3
